...
const NotFoundPage = () => {
  ...
  return (
    <div className='flex flex-col space-y-6 items-center justify-start mt-20 h-fit'>
        ...
        <FuzzyText color={textColor} baseIntensity={0.2} hoverIntensity={0.5} enableHover className='block mx-auto'>404</FuzzyText>
        <FuzzyText color={textColor} fontSize='3rem' baseIntensity={0.2} hoverIntensity={0.5} enableHover className='block mx-auto'>Page Not Found</FuzzyText>
